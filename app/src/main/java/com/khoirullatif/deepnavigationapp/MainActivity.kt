package com.khoirullatif.deepnavigationapp
...
import com.khoirullatif.deepnavigationapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showNotif(this@MainActivity, getString(R.string.notification_title), getString(R.string.notification_message), 110)
    }
